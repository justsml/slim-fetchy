(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["slim-fetchy"] = factory();
	else
		root["slim-fetchy"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetch(url, _ref) {
	  ...
	  var contentType = _ref$contentType === undefined ? 'json' : _ref$contentType;
	  var _ref$session = _ref.session;
	  var session = _ref$session === undefined ? true : _ref$session;
	  var body = _ref.body;
	  var data = _ref.data;

	  body = body || data; // fallback for data param
	  if (method === 'GET' && (typeof body === 'undefined' ? 'undefined' : _typeof(body)) === 'object') {
	  ...
	  var defaultHeaders = {
	    ...
	    'Content-Type': contentType === 'json' ? 'application/json' : contentType === 'text' ? 'text/plain' : 'application/xhtml+xml'
	  };
	  var payload = {
